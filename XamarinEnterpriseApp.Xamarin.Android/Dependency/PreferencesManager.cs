...
[assembly: XF.Dependency(typeof(PreferencesManager))]
namespace XamarinEnterpriseApp.Xamarin.Droid.Dependency
{
    public class PreferencesManager : IPreferencesManager
    {
        ...
        public Task PlatformSet<T>(string key, T value)
        {
            lock (locker)
            {
                using (var sharedPreferences = GetSharedPreferences(Settings))
        ...
        private ISharedPreferences GetSharedPreferences(string sharedName)
        {
