...
{
    public class GetReportDetailsResponse : BaseResponse
    {
        ...
        [JsonProperty("Ithd_location_coord_x")]
        public string IthdLocationCoordX { get; set; }

        [JsonProperty("Ithd_location_coord_y")]
        public string IthdLocationCoordY { get; set; }
        ...
        public string IthdDatePlanned { get; set; }
